...
}]).factory('Current', ['$resource', '$location', function ($resource, $location) {
	return new _appResourcesCurrent2['default']($resource, $location);
	...
	_createClass(City, [{
		...
		value: function api() {
			...
			return this._$resource(url, {}, {
				...
				'index': { method: 'GET', params: { only: 'name,slug' }, isArray: true, cache: true }
			});
		}
...
var Current = (function () {
	function Current($resource, $location) {
