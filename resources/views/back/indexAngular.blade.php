<!DOCTYPE html>
<html xmlns:ng="http://angularjs.org" ng-app="panelApp">
    <head>
    <meta charset="utf-8">
  ...
  <body class="hold-transition skin-blue sidebar-mini" >
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="{{action('Home@index')}}" class="logo">
            ...
            <ul class="nav navbar-nav">
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <!-- User Image -->
                            <img src="{{ asset('assets/back/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
                          </div>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="{{ asset('assets/back/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
