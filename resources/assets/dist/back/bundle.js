...
myApp.controller('PanelCtrl', ['$scope', function ($scope) {
	return new _appControllersPanelCtrlJs2['default']($scope);
}]).controller('CityCtrl', ['$scope', '$filter', 'City', 'ngNotify', function ($scope, $filter, City, ngNotify) {
	return new _appControllersCityCtrlJs2['default']($scope, $filter, City, ngNotify);
}]).controller('CityEditCtrl', ['$scope', 'City', '$routeParams', 'uiGmapGoogleMapApi', 'ngNotify', function ($scope, City, $routeParams, uiGmapGoogleMapApi, ngNotify) {
	return new _appControllersCityEditCtrlJs2['default']($scope, City, $routeParams, uiGmapGoogleMapApi, ngNotify);
}]);
