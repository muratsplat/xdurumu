...
class AddSupportTurkishCharactersToCitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // SQLITE doesnt support changing collation
            ...
            //
            DB::statement('ALTER TABLE `cities` CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci');
    }
    ...
    public function down()
    {
        ...
        DB::statement('ALTER TABLE `cities` CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci');
    }
}
